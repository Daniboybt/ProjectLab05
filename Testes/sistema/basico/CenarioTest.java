...
public class CenarioTest {
	...
	public void testCriarCenario() {
		...
		Cenario cenario1 = new Cenario("", 1);
		Cenario cenario4 = new Cenario("Tarzan preso hoje", 2);
	...
	public void testCriarCenario2() {
		...
		Cenario cenario2 = new Cenario(null, 3);
	}
	
	@Test
	public void testAll() {
		Cenario cenario3 = new Cenario("Tarzan preso hoje", 4);
		...
		Cenario cenario5 = new Cenario("Aurora virá novamente ao Brasil!", 5);
		...
		Cenario cenario6 = new Cenario("esse teste vai passar!", 6);
